...
1.  **Crear un repositorio en GitHub** Ingresá a tu cuenta de GitHub y creá un repositorio nuevo, haciendo click en el botón verde que está arriba a la derecha, *New*.

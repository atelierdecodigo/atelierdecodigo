...
-   [Reproducibilidad](https://atelierdecodigo.com/posts/reproducibilidad.html) limitada si no se trabaja explícitamente con [scripts](https://atelierdecodigo.com/posts/consola-script-escribir-codigo.html).
...
Python no nació como lenguaje estadístico, pero se consolidó como una herramienta central en [ciencia de datos](https://atelierdecodigo.com/posts/que-es-ciencia-de-datos.html) gracias a sus librerías.
...
R fue diseñado desde su origen como un entorno para estadística y análisis de datos. Esto se refleja tanto en su sintaxis como en su [ecosistema de paquetes](https://atelierdecodigo.com/posts/r-base-tidyverse.html).
...
-   Facilita análisis [reproducibles](https://atelierdecodigo.com/posts/reproducibilidad.html) mediante scripts, [RMarkdown](https://macarenaquiroga.com/post/guia-hiper-basica-a-rmarkdown/) y Quarto.
